...
.method public static a(Landroid/app/Activity;)V
    ...
    invoke-direct {v1}, Landroid/arch/lifecycle/k;-><init>()V
...
.method private a(Landroid/arch/lifecycle/k$a;)V
    .locals 0

    if-eqz p1, :cond_0

    .line 54
    invoke-interface {p1}, Landroid/arch/lifecycle/k$a;->a()V

    :cond_0
    return-void
.end method

.method private b(Landroid/arch/lifecycle/k$a;)V
    .locals 0

    if-eqz p1, :cond_0

    .line 60
    invoke-interface {p1}, Landroid/arch/lifecycle/k$a;->b()V

    :cond_0
    return-void
.end method

.method private c(Landroid/arch/lifecycle/k$a;)V
    .locals 0

    if-eqz p1, :cond_0

    .line 66
    invoke-interface {p1}, Landroid/arch/lifecycle/k$a;->c()V
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    .line 73
    iget-object p1, p0, Landroid/arch/lifecycle/k;->a:Landroid/arch/lifecycle/k$a;

    invoke-direct {p0, p1}, Landroid/arch/lifecycle/k;->a(Landroid/arch/lifecycle/k$a;)V

    .line 74
    sget-object p1, Landroid/arch/lifecycle/Lifecycle$Event;->ON_CREATE:Landroid/arch/lifecycle/Lifecycle$Event;

    invoke-direct {p0, p1}, Landroid/arch/lifecycle/k;->a(Landroid/arch/lifecycle/Lifecycle$Event;)V
...
.method public onDestroy()V
    ...
    invoke-direct {p0, v0}, Landroid/arch/lifecycle/k;->a(Landroid/arch/lifecycle/Lifecycle$Event;)V
...
.method public onResume()V
    ...
    .line 87
    iget-object v0, p0, Landroid/arch/lifecycle/k;->a:Landroid/arch/lifecycle/k$a;

    invoke-direct {p0, v0}, Landroid/arch/lifecycle/k;->c(Landroid/arch/lifecycle/k$a;)V
...
.method public onStart()V
    ...
    invoke-direct {p0, v0}, Landroid/arch/lifecycle/k;->b(Landroid/arch/lifecycle/k$a;)V
