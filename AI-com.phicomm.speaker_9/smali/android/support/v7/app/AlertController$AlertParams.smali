...
.field public O:Landroid/support/v7/app/AlertController$AlertParams$a;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 908
    iput-boolean v0, p0, Landroid/support/v7/app/AlertController$AlertParams;->P:Z
...
.method private b(Landroid/support/v7/app/AlertController;)V
    ...
    .line 991
    iget-boolean v1, p0, Landroid/support/v7/app/AlertController$AlertParams;->G:Z
    ...
    .line 992
    iget-object v1, p0, Landroid/support/v7/app/AlertController$AlertParams;->K:Landroid/database/Cursor;
    ...
    iget-object v6, p0, Landroid/support/v7/app/AlertController$AlertParams;->v:[Ljava/lang/CharSequence;
    ...
    .line 1037
    :cond_1
    iget-boolean v1, p0, Landroid/support/v7/app/AlertController$AlertParams;->H:Z
    ...
    iget-object v5, p0, Landroid/support/v7/app/AlertController$AlertParams;->K:Landroid/database/Cursor;

    new-array v6, v8, [Ljava/lang/String;

    iget-object v7, p0, Landroid/support/v7/app/AlertController$AlertParams;->L:Ljava/lang/String;
    ...
    .line 1046
    :cond_3
    iget-object v1, p0, Landroid/support/v7/app/AlertController$AlertParams;->w:Landroid/widget/ListAdapter;

    if-eqz v1, :cond_4

    .line 1047
    iget-object v9, p0, Landroid/support/v7/app/AlertController$AlertParams;->w:Landroid/widget/ListAdapter;
    ...
    .line 1053
    :goto_2
    iget-object v1, p0, Landroid/support/v7/app/AlertController$AlertParams;->O:Landroid/support/v7/app/AlertController$AlertParams$a;
    ...
    invoke-interface {v1, v0}, Landroid/support/v7/app/AlertController$AlertParams$a;->a(Landroid/widget/ListView;)V
    ...
    .line 1061
    iget v1, p0, Landroid/support/v7/app/AlertController$AlertParams;->I:I

    iput v1, p1, Landroid/support/v7/app/AlertController;->k:I

    .line 1063
    iget-object v1, p0, Landroid/support/v7/app/AlertController$AlertParams;->x:Landroid/content/DialogInterface$OnClickListener;
    ...
    .line 1073
    :cond_6
    iget-object v1, p0, Landroid/support/v7/app/AlertController$AlertParams;->J:Landroid/content/DialogInterface$OnMultiChoiceClickListener;
    ...
    :cond_7
    :goto_3
    iget-object v1, p0, Landroid/support/v7/app/AlertController$AlertParams;->N:Landroid/widget/AdapterView$OnItemSelectedListener;
...
.method public a(Landroid/support/v7/app/AlertController;)V
    ...
    .line 950
    iget-object v3, p0, Landroid/support/v7/app/AlertController$AlertParams;->i:Ljava/lang/CharSequence;

    iget-object v4, p0, Landroid/support/v7/app/AlertController$AlertParams;->k:Landroid/content/DialogInterface$OnClickListener;

    const/4 v5, 0x0

    iget-object v6, p0, Landroid/support/v7/app/AlertController$AlertParams;->j:Landroid/graphics/drawable/Drawable;
    ...
    .line 954
    iget-object v3, p0, Landroid/support/v7/app/AlertController$AlertParams;->l:Ljava/lang/CharSequence;

    iget-object v4, p0, Landroid/support/v7/app/AlertController$AlertParams;->n:Landroid/content/DialogInterface$OnClickListener;

    const/4 v5, 0x0

    iget-object v6, p0, Landroid/support/v7/app/AlertController$AlertParams;->m:Landroid/graphics/drawable/Drawable;
    ...
    .line 958
    iget-object v3, p0, Landroid/support/v7/app/AlertController$AlertParams;->o:Ljava/lang/CharSequence;

    iget-object v4, p0, Landroid/support/v7/app/AlertController$AlertParams;->q:Landroid/content/DialogInterface$OnClickListener;

    const/4 v5, 0x0

    iget-object v6, p0, Landroid/support/v7/app/AlertController$AlertParams;->p:Landroid/graphics/drawable/Drawable;
    ...
    .line 968
    iget-object v2, p0, Landroid/support/v7/app/AlertController$AlertParams;->z:Landroid/view/View;

    iget v3, p0, Landroid/support/v7/app/AlertController$AlertParams;->A:I

    iget v4, p0, Landroid/support/v7/app/AlertController$AlertParams;->B:I

    iget v5, p0, Landroid/support/v7/app/AlertController$AlertParams;->C:I

    iget v6, p0, Landroid/support/v7/app/AlertController$AlertParams;->D:I
