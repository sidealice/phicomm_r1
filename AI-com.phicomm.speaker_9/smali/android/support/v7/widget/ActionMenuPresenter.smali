...
.method static synthetic c(Landroid/support/v7/widget/ActionMenuPresenter;)Landroid/support/v7/view/menu/n;
    .locals 0

    .line 52
    iget-object p0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->f:Landroid/support/v7/view/menu/n;
...
.method public a(Landroid/os/Parcelable;)V
    ...
    .line 583
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Landroid/support/v7/view/menu/s;)Z
...
.method public a(Landroid/support/v7/view/menu/h;Landroid/support/v7/view/menu/n$a;)V
    ...
    .line 212
    iget-object p1, p0, Landroid/support/v7/widget/ActionMenuPresenter;->f:Landroid/support/v7/view/menu/n;
...
.method public a()Z
    ...
    .line 431
    iget-object v7, v0, Landroid/support/v7/widget/ActionMenuPresenter;->f:Landroid/support/v7/view/menu/n;
    ...
    .line 441
    :cond_1
    invoke-virtual {v13}, Landroid/support/v7/view/menu/h;->j()Z
    ...
    invoke-virtual {v0, v14, v15, v7}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Landroid/support/v7/view/menu/h;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 496
    :cond_c
    invoke-virtual {v14}, Landroid/support/v7/view/menu/h;->j()Z
    ...
    invoke-virtual {v0, v14, v2, v7}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Landroid/support/v7/view/menu/h;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 542
    invoke-virtual {v15}, Landroid/support/v7/view/menu/h;->i()Z
...
.method public a(Landroid/support/v7/view/menu/s;)Z
    ...
    .line 287
    :goto_0
    invoke-virtual {v0}, Landroid/support/v7/view/menu/s;->s()Landroid/view/Menu;
    ...
    invoke-direct {v2, p0, v3, p1, v0}, Landroid/support/v7/widget/ActionMenuPresenter$a;-><init>(Landroid/support/v7/widget/ActionMenuPresenter;Landroid/content/Context;Landroid/support/v7/view/menu/s;Landroid/view/View;)V
