...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    .line 143
    iput v1, p0, Landroid/support/v7/widget/ab$a;->a:I

    .line 144
    iput v0, p0, Landroid/support/v7/widget/ab$a;->b:I

    goto :goto_0

    .line 146
    :cond_0
    iput v0, p0, Landroid/support/v7/widget/ab$a;->a:I

    .line 147
    iput v1, p0, Landroid/support/v7/widget/ab$a;->b:I
...
.method public bridge synthetic a(IIIII)I
    ...
    .line 128
    invoke-super/range {p0 .. p5}, Landroid/support/v7/widget/v;->a(IIIII)I
...
.method public bridge synthetic a(Landroid/view/MotionEvent;I)Z
    ...
    .line 128
    invoke-super {p0, p1, p2}, Landroid/support/v7/widget/v;->a(Landroid/view/MotionEvent;I)Z
...
.method public bridge synthetic hasFocus()Z
    ...
    .line 128
    invoke-super {p0}, Landroid/support/v7/widget/v;->hasFocus()Z
...
.method public bridge synthetic hasWindowFocus()Z
    ...
    .line 128
    invoke-super {p0}, Landroid/support/v7/widget/v;->hasWindowFocus()Z
...
.method public bridge synthetic isFocused()Z
    ...
    .line 128
    invoke-super {p0}, Landroid/support/v7/widget/v;->isFocused()Z
...
.method public bridge synthetic isInTouchMode()Z
    ...
    .line 128
    invoke-super {p0}, Landroid/support/v7/widget/v;->isInTouchMode()Z
...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 183
    iget-object v0, p0, Landroid/support/v7/widget/ab$a;->c:Landroid/support/v7/widget/aa;
    ...
    .line 209
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/ab$a;->d:Landroid/view/MenuItem;

    if-eq v1, v2, :cond_3

    .line 211
    invoke-virtual {v0}, Landroid/support/v7/view/menu/f;->a()Landroid/support/v7/view/menu/MenuBuilder;
    ...
    .line 213
    iget-object v3, p0, Landroid/support/v7/widget/ab$a;->c:Landroid/support/v7/widget/aa;

    invoke-interface {v3, v0, v1}, Landroid/support/v7/widget/aa;->a(Landroid/support/v7/view/menu/MenuBuilder;Landroid/view/MenuItem;)V

    .line 216
    :cond_2
    iput-object v2, p0, Landroid/support/v7/widget/ab$a;->d:Landroid/view/MenuItem;

    if-eqz v2, :cond_3

    .line 219
    iget-object v1, p0, Landroid/support/v7/widget/ab$a;->c:Landroid/support/v7/widget/aa;

    invoke-interface {v1, v0, v2}, Landroid/support/v7/widget/aa;->b(Landroid/support/v7/view/menu/MenuBuilder;Landroid/view/MenuItem;)V
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 162
    iget v2, p0, Landroid/support/v7/widget/ab$a;->a:I
    ...
    .line 170
    iget v0, p0, Landroid/support/v7/widget/ab$a;->b:I
    ...
    invoke-virtual {p1}, Landroid/support/v7/view/menu/f;->a()Landroid/support/v7/view/menu/MenuBuilder;
...
.method public setHoverListener(Landroid/support/v7/widget/aa;)V
    ...
    .line 152
    iput-object p1, p0, Landroid/support/v7/widget/ab$a;->c:Landroid/support/v7/widget/aa;
