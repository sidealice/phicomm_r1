...
.method private b()I
    ...
    invoke-virtual {p0, v0, v5}, Landroid/support/v7/widget/ListPopupWindow;->a(Landroid/content/Context;Z)Landroid/support/v7/widget/v;

    move-result-object v5

    iput-object v5, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Landroid/support/v7/widget/v;
    ...
    .line 1159
    iget-object v5, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Landroid/support/v7/widget/v;
    ...
    invoke-virtual {v5, v6}, Landroid/support/v7/widget/v;->setAdapter(Landroid/widget/ListAdapter;)V
    ...
    invoke-virtual {v5, v6}, Landroid/support/v7/widget/v;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V

    .line 1163
    iget-object v5, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Landroid/support/v7/widget/v;

    invoke-virtual {v5, v3}, Landroid/support/v7/widget/v;->setFocusable(Z)V

    .line 1164
    iget-object v5, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Landroid/support/v7/widget/v;

    invoke-virtual {v5, v3}, Landroid/support/v7/widget/v;->setFocusableInTouchMode(Z)V
    ...
    invoke-virtual {v5, v6}, Landroid/support/v7/widget/v;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V
    ...
    invoke-virtual {v5, v6}, Landroid/support/v7/widget/v;->setOnScrollListener(Landroid/widget/AbsListView$OnScrollListener;)V
    ...
    .line 1300
    :goto_7
    iget-object v6, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Landroid/support/v7/widget/v;
    ...
    invoke-virtual/range {v6 .. v11}, Landroid/support/v7/widget/v;->a(IIIII)I
    ...
    invoke-virtual {v2}, Landroid/support/v7/widget/v;->getPaddingTop()I

    move-result v2

    iget-object v3, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Landroid/support/v7/widget/v;

    .line 1304
    invoke-virtual {v3}, Landroid/support/v7/widget/v;->getPaddingBottom()I
...
.method public a(Landroid/widget/ListAdapter;)V
    ...
    .line 290
    :cond_2
    iget-object p1, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Landroid/support/v7/widget/v;
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/v;->setAdapter(Landroid/widget/ListAdapter;)V
...
.method public d()V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/v;->setSelection(I)V
