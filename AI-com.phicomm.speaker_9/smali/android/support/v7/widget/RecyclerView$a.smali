...
# virtual methods
.method public final bindViewHolder(Landroid/support/v7/widget/RecyclerView$t;I)V
    .locals 2
    ...
    .line 6706
    iput p2, p1, Landroid/support/v7/widget/RecyclerView$t;->mPosition:I
    ...
    iput-wide v0, p1, Landroid/support/v7/widget/RecyclerView$t;->mItemId:J
    ...
    invoke-virtual {p0, p1, p2, v0}, Landroid/support/v7/widget/RecyclerView$a;->onBindViewHolder(Landroid/support/v7/widget/RecyclerView$t;ILjava/util/List;)V

    .line 6715
    invoke-virtual {p1}, Landroid/support/v7/widget/RecyclerView$t;->clearPayload()V
    ...
    .line 6717
    instance-of p2, p1, Landroid/support/v7/widget/RecyclerView$h;
    ...
    iput-boolean v1, p1, Landroid/support/v7/widget/RecyclerView$h;->e:Z
...
.method public final createViewHolder(Landroid/view/ViewGroup;I)Landroid/support/v7/widget/RecyclerView$t;
    .locals 1
    ...
    .line 6685
    invoke-virtual {p0, p1, p2}, Landroid/support/v7/widget/RecyclerView$a;->onCreateViewHolder(Landroid/view/ViewGroup;I)Landroid/support/v7/widget/RecyclerView$t;
    ...
    .line 6691
    :cond_0
    iput p2, p1, Landroid/support/v7/widget/RecyclerView$t;->mItemViewType:I
    :try_end_0
...
.method public abstract onBindViewHolder(Landroid/support/v7/widget/RecyclerView$t;I)V
    .param p1    # Landroid/support/v7/widget/RecyclerView$t;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
...
.method public onBindViewHolder(Landroid/support/v7/widget/RecyclerView$t;ILjava/util/List;)V
    .locals 0
    .param p1    # Landroid/support/v7/widget/RecyclerView$t;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    ...
    .line 6673
    invoke-virtual {p0, p1, p2}, Landroid/support/v7/widget/RecyclerView$a;->onBindViewHolder(Landroid/support/v7/widget/RecyclerView$t;I)V

    return-void
.end method

.method public abstract onCreateViewHolder(Landroid/view/ViewGroup;I)Landroid/support/v7/widget/RecyclerView$t;
    .param p1    # Landroid/view/ViewGroup;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
...
.method public onFailedToRecycleView(Landroid/support/v7/widget/RecyclerView$t;)Z
    .locals 0
    .param p1    # Landroid/support/v7/widget/RecyclerView$t;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method public onViewDetachedFromWindow(Landroid/support/v7/widget/RecyclerView$t;)V
    .locals 0
    .param p1    # Landroid/support/v7/widget/RecyclerView$t;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method public onViewRecycled(Landroid/support/v7/widget/RecyclerView$t;)V
    .locals 0
    .param p1    # Landroid/support/v7/widget/RecyclerView$t;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
