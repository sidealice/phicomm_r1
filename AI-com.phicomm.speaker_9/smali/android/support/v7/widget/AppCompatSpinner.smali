...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    iput-object v2, p0, Landroid/support/v7/widget/AppCompatSpinner;->b:Landroid/support/v7/widget/f;
    ...
    invoke-virtual {v0, p5, v1}, Landroid/support/v7/widget/ao;->g(II)I
    ...
    invoke-static {p5, p2, v4, p3, v1}, Landroid/support/v7/widget/ao;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/ao;
    ...
    invoke-virtual {p5, v1, v4}, Landroid/support/v7/widget/ao;->f(II)I
    ...
    .line 240
    invoke-virtual {p5, v1}, Landroid/support/v7/widget/ao;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ao;->d(I)Ljava/lang/String;
    ...
    .line 242
    invoke-virtual {p5}, Landroid/support/v7/widget/ao;->a()V
    ...
    iput-object p5, p0, Landroid/support/v7/widget/AppCompatSpinner;->d:Landroid/support/v7/widget/x;

    .line 262
    :cond_6
    sget p4, Landroid/support/v7/appcompat/R$styleable;->Spinner_android_entries:I

    invoke-virtual {v0, p4}, Landroid/support/v7/widget/ao;->f(I)[Ljava/lang/CharSequence;
    ...
    .line 281
    :cond_8
    iget-object p1, p0, Landroid/support/v7/widget/AppCompatSpinner;->b:Landroid/support/v7/widget/f;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 412
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->d:Landroid/support/v7/widget/x;
