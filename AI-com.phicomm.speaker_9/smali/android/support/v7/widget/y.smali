...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Landroid/support/v7/widget/y$1;-><init>()V

    sput-object v0, Landroid/support/v7/widget/y;->e:Ljava/util/Comparator;
...
.method private a(Landroid/support/v7/widget/RecyclerView;IJ)Landroid/support/v7/widget/RecyclerView$t;
    .locals 2
    ...
    .line 285
    invoke-virtual {v0, p2, v1, p3, p4}, Landroid/support/v7/widget/RecyclerView$n;->a(IZJ)Landroid/support/v7/widget/RecyclerView$t;
    ...
    .line 289
    invoke-virtual {p2}, Landroid/support/v7/widget/RecyclerView$t;->isBound()Z

    move-result p3

    if-eqz p3, :cond_1

    invoke-virtual {p2}, Landroid/support/v7/widget/RecyclerView$t;->isInvalid()Z
    ...
    .line 292
    iget-object p3, p2, Landroid/support/v7/widget/RecyclerView$t;->itemView:Landroid/view/View;

    invoke-virtual {v0, p3}, Landroid/support/v7/widget/RecyclerView$n;->a(Landroid/view/View;)V

    goto :goto_0

    .line 298
    :cond_1
    invoke-virtual {v0, p2, v1}, Landroid/support/v7/widget/RecyclerView$n;->a(Landroid/support/v7/widget/RecyclerView$t;Z)V
    :try_end_0
...
.method private a()V
    ...
    .line 217
    iget-object v4, p0, Landroid/support/v7/widget/y;->b:Ljava/util/ArrayList;
    ...
    .line 219
    iget-object v5, v4, Landroid/support/v7/widget/RecyclerView;->B:Landroid/support/v7/widget/y$a;
    ...
    sget-object v1, Landroid/support/v7/widget/y;->e:Ljava/util/Comparator;
...
.method private a(Landroid/support/v7/widget/RecyclerView;J)V
    ...
    .line 321
    :cond_1
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView;->B:Landroid/support/v7/widget/y$a;
    ...
    .line 327
    iget-object v1, p1, Landroid/support/v7/widget/RecyclerView;->C:Landroid/support/v7/widget/RecyclerView$State;

    iget-object v2, p1, Landroid/support/v7/widget/RecyclerView;->l:Landroid/support/v7/widget/RecyclerView$a;

    invoke-virtual {v1, v2}, Landroid/support/v7/widget/RecyclerView$State;->a(Landroid/support/v7/widget/RecyclerView$a;)V
    ...
    .line 332
    invoke-direct {p0, p1, v2, p2, p3}, Landroid/support/v7/widget/y;->a(Landroid/support/v7/widget/RecyclerView;IJ)Landroid/support/v7/widget/RecyclerView$t;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private a(Landroid/support/v7/widget/y$b;J)V
    ...
    invoke-direct {p0, v2, p1, v0, v1}, Landroid/support/v7/widget/y;->a(Landroid/support/v7/widget/RecyclerView;IJ)Landroid/support/v7/widget/RecyclerView$t;
    ...
    .line 344
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView$t;->mNestedRecyclerView:Ljava/lang/ref/WeakReference;
    ...
    .line 348
    iget-object p1, p1, Landroid/support/v7/widget/RecyclerView$t;->mNestedRecyclerView:Ljava/lang/ref/WeakReference;
...
.method a(Landroid/support/v7/widget/RecyclerView;II)V
    ...
    .line 178
    iget-wide v0, p0, Landroid/support/v7/widget/y;->c:J
    ...
    iput-wide v0, p0, Landroid/support/v7/widget/y;->c:J
    ...
    .line 184
    :cond_0
    iget-object p1, p1, Landroid/support/v7/widget/RecyclerView;->B:Landroid/support/v7/widget/y$a;
...
.method public run()V
    ...
    .line 373
    iget-object v2, p0, Landroid/support/v7/widget/y;->b:Ljava/util/ArrayList;
    ...
    .line 383
    iget-object v6, p0, Landroid/support/v7/widget/y;->b:Ljava/util/ArrayList;
    ...
    iget-wide v4, p0, Landroid/support/v7/widget/y;->d:J

    add-long v6, v2, v4

    .line 396
    invoke-virtual {p0, v6, v7}, Landroid/support/v7/widget/y;->a(J)V
    :try_end_2
