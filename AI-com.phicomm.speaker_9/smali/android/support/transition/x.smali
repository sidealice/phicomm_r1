...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/transition/x;->g:Ljava/util/ArrayList;

    const/4 v0, 0x1

    .line 63
    iput-boolean v0, p0, Landroid/support/transition/x;->h:Z

    const/4 v0, 0x0

    .line 65
    iput-boolean v0, p0, Landroid/support/transition/x;->j:Z

    return-void
.end method

.method static synthetic a(Landroid/support/transition/x;)Z
    .locals 0

    .line 60
    iget-boolean p0, p0, Landroid/support/transition/x;->j:Z

    return p0
.end method

.method static synthetic a(Landroid/support/transition/x;Z)Z
    .locals 0

    .line 60
    iput-boolean p1, p0, Landroid/support/transition/x;->j:Z

    return p1
.end method

.method static synthetic b(Landroid/support/transition/x;)I
    .locals 1

    .line 60
    iget v0, p0, Landroid/support/transition/x;->i:I

    add-int/lit8 v0, v0, -0x1

    iput v0, p0, Landroid/support/transition/x;->i:I

    return v0
.end method

.method static synthetic c(Landroid/support/transition/x;)I
    .locals 0

    .line 60
    iget p0, p0, Landroid/support/transition/x;->i:I
...
.method private p()V
    ...
    invoke-direct {v0, p0}, Landroid/support/transition/x$a;-><init>(Landroid/support/transition/x;)V

    .line 364
    iget-object v1, p0, Landroid/support/transition/x;->g:Ljava/util/ArrayList;
    ...
    .line 367
    :cond_0
    iget-object v0, p0, Landroid/support/transition/x;->g:Ljava/util/ArrayList;
...
.method public synthetic a(J)Landroid/support/transition/Transition;
    ...
    .line 60
    invoke-virtual {p0, p1, p2}, Landroid/support/transition/x;->c(J)Landroid/support/transition/x;
...
.method public synthetic a(Landroid/animation/TimeInterpolator;)Landroid/support/transition/Transition;
    ...
    .line 60
    invoke-virtual {p0, p1}, Landroid/support/transition/x;->b(Landroid/animation/TimeInterpolator;)Landroid/support/transition/x;
...
.method public synthetic a(Landroid/support/transition/Transition$c;)Landroid/support/transition/Transition;
    ...
    .line 60
    invoke-virtual {p0, p1}, Landroid/support/transition/x;->c(Landroid/support/transition/Transition$c;)Landroid/support/transition/x;
...
.method public a(I)Landroid/support/transition/x;
    .locals 3
    .annotation build Landroid/support/annotation/NonNull;
    .end annotation
    ...
    .line 112
    iput-boolean p1, p0, Landroid/support/transition/x;->h:Z
...
.method a(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 584
    :goto_0
    iget-object v2, p0, Landroid/support/transition/x;->g:Ljava/util/ArrayList;
...
.method public a(Landroid/support/transition/z;)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/transition/x;->a(Landroid/view/View;)Z
    ...
    .line 472
    invoke-virtual {v1, p1}, Landroid/support/transition/Transition;->a(Landroid/support/transition/z;)V
...
.method protected a(Landroid/view/ViewGroup;Landroid/support/transition/aa;Landroid/support/transition/aa;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    .line 411
    invoke-virtual {v0}, Landroid/support/transition/x;->c()J

    move-result-wide v1

    .line 412
    iget-object v3, v0, Landroid/support/transition/x;->g:Ljava/util/ArrayList;
    ...
    .line 414
    iget-object v5, v0, Landroid/support/transition/x;->g:Ljava/util/ArrayList;
    ...
    .line 417
    iget-boolean v5, v0, Landroid/support/transition/x;->h:Z
    ...
    .line 425
    invoke-virtual/range {v6 .. v11}, Landroid/support/transition/Transition;->a(Landroid/view/ViewGroup;Landroid/support/transition/aa;Landroid/support/transition/aa;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
...
.method public synthetic b(J)Landroid/support/transition/Transition;
    ...
    .line 60
    invoke-virtual {p0, p1, p2}, Landroid/support/transition/x;->d(J)Landroid/support/transition/x;
...
.method public synthetic b(Landroid/support/transition/Transition$c;)Landroid/support/transition/Transition;
    ...
    .line 60
    invoke-virtual {p0, p1}, Landroid/support/transition/x;->d(Landroid/support/transition/Transition$c;)Landroid/support/transition/x;
...
.method public synthetic b(Landroid/view/View;)Landroid/support/transition/Transition;
    ...
    .line 60
    invoke-virtual {p0, p1}, Landroid/support/transition/x;->f(Landroid/view/View;)Landroid/support/transition/x;
...
.method public b(Landroid/animation/TimeInterpolator;)Landroid/support/transition/x;
    .locals 0
    .param p1    # Landroid/animation/TimeInterpolator;
        .annotation build Landroid/support/annotation/Nullable;
        .end annotation
    ...
    check-cast p1, Landroid/support/transition/x;

    return-object p1
.end method

.method public b(Landroid/support/transition/Transition;)Landroid/support/transition/x;
    .locals 5
    ...
    .line 152
    iput-object p0, p1, Landroid/support/transition/Transition;->d:Landroid/support/transition/x;

    .line 153
    iget-wide v0, p0, Landroid/support/transition/x;->a:J
...
.method public b(Landroid/support/transition/z;)V
    ...
    .line 484
    invoke-virtual {v1, p1}, Landroid/support/transition/Transition;->b(Landroid/support/transition/z;)V
...
.method public synthetic c(Landroid/view/View;)Landroid/support/transition/Transition;
    ...
    .line 60
    invoke-virtual {p0, p1}, Landroid/support/transition/x;->g(Landroid/view/View;)Landroid/support/transition/x;
...
.method public c(J)Landroid/support/transition/x;
    .locals 5
    .annotation build Landroid/support/annotation/NonNull;
    .end annotation
...
.method public c(Landroid/support/transition/Transition$c;)Landroid/support/transition/x;
    .locals 0
    .param p1    # Landroid/support/transition/Transition$c;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method c(Landroid/support/transition/z;)V
    ...
    .line 493
    invoke-super {p0, p1}, Landroid/support/transition/Transition;->c(Landroid/support/transition/z;)V
    ...
    invoke-virtual {v2, p1}, Landroid/support/transition/Transition;->c(Landroid/support/transition/z;)V
...
.method public synthetic clone()Ljava/lang/Object;
    ...
    .line 60
    invoke-virtual {p0}, Landroid/support/transition/x;->m()Landroid/support/transition/Transition;
...
.method public d(J)Landroid/support/transition/x;
    .locals 0
    .annotation build Landroid/support/annotation/NonNull;
    .end annotation
...
.method public d(Landroid/support/transition/Transition$c;)Landroid/support/transition/x;
    .locals 0
    .param p1    # Landroid/support/transition/Transition$c;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method protected e()V
    ...
    .line 437
    invoke-virtual {p0}, Landroid/support/transition/x;->j()V

    .line 438
    invoke-virtual {p0}, Landroid/support/transition/x;->k()V

    return-void

    .line 441
    :cond_0
    invoke-direct {p0}, Landroid/support/transition/x;->p()V

    .line 442
    iget-boolean v0, p0, Landroid/support/transition/x;->h:Z
    ...
    .line 448
    new-instance v3, Landroid/support/transition/x$1;

    invoke-direct {v3, p0, v2}, Landroid/support/transition/x$1;-><init>(Landroid/support/transition/x;Landroid/support/transition/Transition;)V
...
.method public f(Landroid/view/View;)Landroid/support/transition/x;
    .locals 2
    .param p1    # Landroid/view/View;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method public g(Landroid/view/View;)Landroid/support/transition/x;
    .locals 2
    .param p1    # Landroid/view/View;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method public m()Landroid/support/transition/Transition;
    ...
    iput-object v1, v0, Landroid/support/transition/x;->g:Ljava/util/ArrayList;
    ...
    .line 596
    iget-object v3, p0, Landroid/support/transition/x;->g:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v3}, Landroid/support/transition/x;->b(Landroid/support/transition/Transition;)Landroid/support/transition/x;
