...
.field d:Landroid/support/transition/x;

.field e:Z

.field f:Landroid/support/transition/w;
...
.field private u:Landroid/support/transition/aa;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/transition/Transition;->h:Landroid/support/transition/l;
...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Landroid/support/transition/Transition;->u:Landroid/support/transition/aa;
    ...
    iput-object v1, p0, Landroid/support/transition/Transition;->v:Landroid/support/transition/aa;

    .line 197
    iput-object v0, p0, Landroid/support/transition/Transition;->d:Landroid/support/transition/x;
    ...
    .line 252
    sget-object v0, Landroid/support/transition/Transition;->h:Landroid/support/transition/l;

    iput-object v0, p0, Landroid/support/transition/Transition;->J:Landroid/support/transition/l;
...
.method private a(Landroid/support/transition/aa;Landroid/support/transition/aa;)V
    ...
    iget-object v1, p1, Landroid/support/transition/aa;->a:Landroid/support/v4/util/ArrayMap;
    ...
    iget-object v2, p2, Landroid/support/transition/aa;->a:Landroid/support/v4/util/ArrayMap;
    ...
    .line 679
    :pswitch_0
    iget-object v3, p1, Landroid/support/transition/aa;->c:Landroid/support/v4/util/LongSparseArray;

    iget-object v4, p2, Landroid/support/transition/aa;->c:Landroid/support/v4/util/LongSparseArray;
    ...
    .line 675
    :pswitch_1
    iget-object v3, p1, Landroid/support/transition/aa;->b:Landroid/util/SparseArray;

    iget-object v4, p2, Landroid/support/transition/aa;->b:Landroid/util/SparseArray;
    ...
    .line 671
    :pswitch_2
    iget-object v3, p1, Landroid/support/transition/aa;->d:Landroid/support/v4/util/ArrayMap;

    iget-object v4, p2, Landroid/support/transition/aa;->d:Landroid/support/v4/util/ArrayMap;
...
.method private static a(Landroid/support/transition/aa;Landroid/view/View;Landroid/support/transition/z;)V
    ...
    .line 1529
    iget-object v0, p0, Landroid/support/transition/aa;->a:Landroid/support/v4/util/ArrayMap;
    ...
    .line 1541
    iget-object v1, p0, Landroid/support/transition/aa;->d:Landroid/support/v4/util/ArrayMap;
    ...
    .line 1553
    iget-object p2, p0, Landroid/support/transition/aa;->c:Landroid/support/v4/util/LongSparseArray;
    ...
    .line 1555
    iget-object p1, p0, Landroid/support/transition/aa;->c:Landroid/support/v4/util/LongSparseArray;
    ...
    .line 1558
    iget-object p0, p0, Landroid/support/transition/aa;->c:Landroid/support/v4/util/LongSparseArray;
...
.method private a(Landroid/support/v4/util/ArrayMap;Landroid/support/v4/util/ArrayMap;)V
    ...
    .line 545
    iget-object v2, v1, Landroid/support/transition/z;->b:Landroid/view/View;
...
.method private b(Landroid/support/v4/util/ArrayMap;Landroid/support/v4/util/ArrayMap;)V
    ...
    .line 644
    iget-object v4, v2, Landroid/support/transition/z;->b:Landroid/view/View;
...
.method private c(Landroid/view/View;Z)V
    ...
    .line 1618
    invoke-virtual {p0, v1}, Landroid/support/transition/Transition;->a(Landroid/support/transition/z;)V

    goto :goto_1

    .line 1620
    :cond_5
    invoke-virtual {p0, v1}, Landroid/support/transition/Transition;->b(Landroid/support/transition/z;)V
    ...
    .line 1623
    invoke-virtual {p0, v1}, Landroid/support/transition/Transition;->c(Landroid/support/transition/z;)V

    if-eqz p2, :cond_6

    .line 1625
    iget-object v3, p0, Landroid/support/transition/Transition;->u:Landroid/support/transition/aa;

    invoke-static {v3, p1, v1}, Landroid/support/transition/Transition;->a(Landroid/support/transition/aa;Landroid/view/View;Landroid/support/transition/z;)V

    goto :goto_2

    .line 1627
    :cond_6
    iget-object v3, p0, Landroid/support/transition/Transition;->v:Landroid/support/transition/aa;
...
.method public a(Landroid/view/ViewGroup;Landroid/support/transition/z;Landroid/support/transition/z;)Landroid/animation/Animator;
    ...
    .param p2    # Landroid/support/transition/z;
        ...
        .end annotation
    .end param
    .param p3    # Landroid/support/transition/z;
        .annotation build Landroid/support/annotation/Nullable;
        .end annotation
    .end param
    .annotation build Landroid/support/annotation/Nullable;
...
.method public a(Landroid/view/View;Z)Landroid/support/transition/z;
    .locals 1
    ...
    .line 1661
    iget-object v0, p0, Landroid/support/transition/Transition;->d:Landroid/support/transition/x;
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/transition/x;->a(Landroid/view/View;Z)Landroid/support/transition/z;
    ...
    .line 1664
    iget-object p2, p0, Landroid/support/transition/Transition;->u:Landroid/support/transition/aa;

    goto :goto_0

    :cond_1
    iget-object p2, p0, Landroid/support/transition/Transition;->v:Landroid/support/transition/aa;

    .line 1665
    :goto_0
    iget-object p2, p2, Landroid/support/transition/aa;->a:Landroid/support/v4/util/ArrayMap;
...
.method public a(Landroid/support/transition/Transition$b;)V
    .locals 0
    .param p1    # Landroid/support/transition/Transition$b;
        .annotation build Landroid/support/annotation/Nullable;
        .end annotation
    .end param
...
.method a(Landroid/view/ViewGroup;)V
    ...
    .line 1781
    iget-object v0, p0, Landroid/support/transition/Transition;->u:Landroid/support/transition/aa;

    iget-object v1, p0, Landroid/support/transition/Transition;->v:Landroid/support/transition/aa;

    invoke-direct {p0, v0, v1}, Landroid/support/transition/Transition;->a(Landroid/support/transition/aa;Landroid/support/transition/aa;)V

    .line 1783
    invoke-static {}, Landroid/support/transition/Transition;->o()Landroid/support/v4/util/ArrayMap;
    ...
    .line 1785
    invoke-static {p1}, Landroid/support/transition/am;->b(Landroid/view/View;)Landroid/support/transition/av;
    ...
    iget-object v6, v5, Landroid/support/transition/Transition$a;->d:Landroid/support/transition/av;
    ...
    .line 1792
    iget-object v6, v5, Landroid/support/transition/Transition$a;->c:Landroid/support/transition/z;

    .line 1793
    iget-object v7, v5, Landroid/support/transition/Transition$a;->a:Landroid/view/View;

    .line 1794
    invoke-virtual {p0, v7, v3}, Landroid/support/transition/Transition;->a(Landroid/view/View;Z)Landroid/support/transition/z;

    move-result-object v8

    .line 1795
    invoke-virtual {p0, v7, v3}, Landroid/support/transition/Transition;->b(Landroid/view/View;Z)Landroid/support/transition/z;
    ...
    .line 1797
    invoke-virtual {v5, v6, v7}, Landroid/support/transition/Transition;->a(Landroid/support/transition/z;Landroid/support/transition/z;)Z
    ...
    .line 1815
    :cond_5
    iget-object v6, p0, Landroid/support/transition/Transition;->u:Landroid/support/transition/aa;

    iget-object v7, p0, Landroid/support/transition/Transition;->v:Landroid/support/transition/aa;
    ...
    invoke-virtual/range {v4 .. v9}, Landroid/support/transition/Transition;->a(Landroid/view/ViewGroup;Landroid/support/transition/aa;Landroid/support/transition/aa;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
...
.method protected a(Landroid/view/ViewGroup;Landroid/support/transition/aa;Landroid/support/transition/aa;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    .line 722
    invoke-virtual {v6, v2, v3}, Landroid/support/transition/Transition;->a(Landroid/support/transition/z;Landroid/support/transition/z;)Z
    ...
    .line 742
    invoke-virtual {v6, v7, v2, v3}, Landroid/support/transition/Transition;->a(Landroid/view/ViewGroup;Landroid/support/transition/z;Landroid/support/transition/z;)Landroid/animation/Animator;
    ...
    .line 748
    iget-object v15, v3, Landroid/support/transition/z;->b:Landroid/view/View;
    ...
    .line 751
    new-instance v11, Landroid/support/transition/z;

    invoke-direct {v11}, Landroid/support/transition/z;-><init>()V

    .line 752
    iput-object v15, v11, Landroid/support/transition/z;->b:Landroid/view/View;
    ...
    .line 753
    iget-object v5, v10, Landroid/support/transition/aa;->a:Landroid/support/v4/util/ArrayMap;
    ...
    .line 756
    iget-object v13, v11, Landroid/support/transition/z;->a:Ljava/util/Map;

    aget-object v14, v4, v10

    move/from16 v18, v12

    iget-object v12, v5, Landroid/support/transition/z;->a:Ljava/util/Map;
    ...
    .line 764
    iget-object v12, v10, Landroid/support/transition/Transition$a;->c:Landroid/support/transition/z;
    ...
    .line 766
    iget-object v10, v10, Landroid/support/transition/Transition$a;->c:Landroid/support/transition/z;

    invoke-virtual {v10, v11}, Landroid/support/transition/z;->equals(Ljava/lang/Object;)Z
    ...
    .line 778
    iget-object v4, v6, Landroid/support/transition/Transition;->f:Landroid/support/transition/w;
    ...
    invoke-virtual {v4, v7, v6, v2, v3}, Landroid/support/transition/w;->a(Landroid/view/ViewGroup;Landroid/support/transition/Transition;Landroid/support/transition/z;Landroid/support/transition/z;)J
    ...
    .line 784
    invoke-static/range {p1 .. p1}, Landroid/support/transition/am;->b(Landroid/view/View;)Landroid/support/transition/av;
    ...
    invoke-direct/range {v0 .. v5}, Landroid/support/transition/Transition$a;-><init>(Landroid/view/View;Ljava/lang/String;Landroid/support/transition/Transition;Landroid/support/transition/av;Landroid/support/transition/z;)V
...
.method a(Landroid/view/ViewGroup;Z)V
    ...
    .line 1477
    invoke-virtual {p0, v3}, Landroid/support/transition/Transition;->a(Landroid/support/transition/z;)V

    goto :goto_2

    .line 1479
    :cond_4
    invoke-virtual {p0, v3}, Landroid/support/transition/Transition;->b(Landroid/support/transition/z;)V
    ...
    .line 1482
    invoke-virtual {p0, v3}, Landroid/support/transition/Transition;->c(Landroid/support/transition/z;)V

    if-eqz p2, :cond_5

    .line 1484
    iget-object v4, p0, Landroid/support/transition/Transition;->u:Landroid/support/transition/aa;

    invoke-static {v4, v2, v3}, Landroid/support/transition/Transition;->a(Landroid/support/transition/aa;Landroid/view/View;Landroid/support/transition/z;)V

    goto :goto_3

    .line 1486
    :cond_5
    iget-object v4, p0, Landroid/support/transition/Transition;->v:Landroid/support/transition/aa;
    ...
    .line 1495
    invoke-virtual {p0, v2}, Landroid/support/transition/Transition;->a(Landroid/support/transition/z;)V

    goto :goto_5

    .line 1497
    :cond_8
    invoke-virtual {p0, v2}, Landroid/support/transition/Transition;->b(Landroid/support/transition/z;)V
    ...
    .line 1500
    invoke-virtual {p0, v2}, Landroid/support/transition/Transition;->c(Landroid/support/transition/z;)V
    ...
    invoke-static {v3, v0, v2}, Landroid/support/transition/Transition;->a(Landroid/support/transition/aa;Landroid/view/View;Landroid/support/transition/z;)V
    ...
    iget-object v3, v3, Landroid/support/transition/aa;->d:Landroid/support/v4/util/ArrayMap;
...
.method a(Z)V
    ...
    .line 1575
    iget-object p1, p0, Landroid/support/transition/Transition;->u:Landroid/support/transition/aa;

    iget-object p1, p1, Landroid/support/transition/aa;->a:Landroid/support/v4/util/ArrayMap;
    ...
    iget-object p1, p1, Landroid/support/transition/aa;->c:Landroid/support/v4/util/LongSparseArray;
    ...
    .line 1579
    :cond_0
    iget-object p1, p0, Landroid/support/transition/Transition;->v:Landroid/support/transition/aa;
...
.method public a(Landroid/support/transition/z;Landroid/support/transition/z;)Z
    ...
    .line 1841
    invoke-static {p1, p2, v5}, Landroid/support/transition/Transition;->a(Landroid/support/transition/z;Landroid/support/transition/z;Ljava/lang/String;)Z
    ...
    .line 1848
    invoke-static {p1, p2, v3}, Landroid/support/transition/Transition;->a(Landroid/support/transition/z;Landroid/support/transition/z;Ljava/lang/String;)Z
...
.method b(Landroid/view/View;Z)Landroid/support/transition/z;
    .locals 6
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/transition/x;->b(Landroid/view/View;Z)Landroid/support/transition/z;
    ...
    .line 1694
    :cond_3
    iget-object v5, v5, Landroid/support/transition/z;->b:Landroid/view/View;
...
.method c(Landroid/support/transition/z;)V
    ...
    .line 2178
    iget-object v0, p0, Landroid/support/transition/Transition;->f:Landroid/support/transition/w;
    ...
    invoke-virtual {v0}, Landroid/support/transition/w;->a()[Ljava/lang/String;
    ...
    .line 2185
    iget-object v3, p1, Landroid/support/transition/z;->a:Ljava/util/Map;
    ...
    invoke-virtual {v0, p1}, Landroid/support/transition/w;->a(Landroid/support/transition/z;)V
...
.method public d(Landroid/view/View;)V
    ...
    iget-object v3, v3, Landroid/support/transition/Transition$a;->d:Landroid/support/transition/av;
...
.method protected k()V
    ...
    iget-object v3, v3, Landroid/support/transition/aa;->c:Landroid/support/v4/util/LongSparseArray;
...
.method public l()Landroid/support/transition/l;
    ...
    .line 2092
    iget-object v0, p0, Landroid/support/transition/Transition;->J:Landroid/support/transition/l;
...
.method public m()Landroid/support/transition/Transition;
    ...
    iput-object v2, v1, Landroid/support/transition/Transition;->u:Landroid/support/transition/aa;
    ...
    iput-object v2, v1, Landroid/support/transition/Transition;->v:Landroid/support/transition/aa;
