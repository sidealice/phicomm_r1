...
# instance fields
.field private final a:Landroid/support/transition/x;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroid/support/design/internal/BottomNavigationMenuView;->a:Landroid/support/transition/x;

    .line 85
    iget-object v0, p0, Landroid/support/design/internal/BottomNavigationMenuView;->a:Landroid/support/transition/x;

    invoke-virtual {v0, p1}, Landroid/support/transition/x;->a(I)Landroid/support/transition/x;

    .line 86
    iget-object p1, p0, Landroid/support/design/internal/BottomNavigationMenuView;->a:Landroid/support/transition/x;

    const-wide/16 v0, 0x73

    invoke-virtual {p1, v0, v1}, Landroid/support/transition/x;->c(J)Landroid/support/transition/x;
    ...
    invoke-virtual {p1, v0}, Landroid/support/transition/x;->b(Landroid/animation/TimeInterpolator;)Landroid/support/transition/x;
    ...
    invoke-virtual {p1, v0}, Landroid/support/transition/x;->b(Landroid/support/transition/Transition;)Landroid/support/transition/x;
...
.method public a()V
    ...
    invoke-virtual {v2, v4, v1}, Landroid/support/design/internal/BottomNavigationItemView;->a(Landroid/support/v7/view/menu/h;I)V
...
.method public b()V
    ...
    .line 308
    iget-object v1, p0, Landroid/support/design/internal/BottomNavigationMenuView;->a:Landroid/support/transition/x;

    invoke-static {p0, v1}, Landroid/support/transition/v;->a(Landroid/view/ViewGroup;Landroid/support/transition/Transition;)V
    ...
    invoke-virtual {v3, v4, v2}, Landroid/support/design/internal/BottomNavigationItemView;->a(Landroid/support/v7/view/menu/h;I)V
