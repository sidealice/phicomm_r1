...
.method constructor <init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/k;)V
    ...
    .line 90
    iput-object p1, p0, Landroid/support/design/widget/f;->n:Landroid/support/design/widget/VisibilityAwareImageButton;
    ...
    .line 107
    iget-object p1, p0, Landroid/support/design/widget/f;->n:Landroid/support/design/widget/VisibilityAwareImageButton;
...
.method private p()Z
    ...
    .line 505
    iget-object v0, p0, Landroid/support/design/widget/f;->n:Landroid/support/design/widget/VisibilityAwareImageButton;
...
.method private q()V
    ...
    .line 527
    :cond_2
    iget-object v0, p0, Landroid/support/design/widget/f;->f:Landroid/support/design/widget/b;
...
.method a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;II)V
    ...
    iput-object p2, p0, Landroid/support/design/widget/f;->e:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p1, p0, Landroid/support/design/widget/f;->f:Landroid/support/design/widget/b;
    ...
    iget-object p4, p0, Landroid/support/design/widget/f;->f:Landroid/support/design/widget/b;

    aput-object p4, p1, v0

    iget-object p4, p0, Landroid/support/design/widget/f;->d:Landroid/graphics/drawable/Drawable;

    aput-object p4, p1, p3

    iget-object p3, p0, Landroid/support/design/widget/f;->e:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p2, p0, Landroid/support/design/widget/f;->d:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p2, p0, Landroid/support/design/widget/f;->g:Landroid/graphics/drawable/Drawable;

    .line 139
    new-instance p1, Landroid/support/design/widget/j;

    iget-object p2, p0, Landroid/support/design/widget/f;->n:Landroid/support/design/widget/VisibilityAwareImageButton;
    ...
    iget-object v3, p0, Landroid/support/design/widget/f;->g:Landroid/graphics/drawable/Drawable;

    iget-object p2, p0, Landroid/support/design/widget/f;->o:Landroid/support/design/widget/k;

    .line 142
    invoke-interface {p2}, Landroid/support/design/widget/k;->a()F

    move-result v4

    iget v5, p0, Landroid/support/design/widget/f;->h:F

    iget p2, p0, Landroid/support/design/widget/f;->h:F

    iget p3, p0, Landroid/support/design/widget/f;->i:F

    add-float v6, p2, p3

    move-object v1, p1

    invoke-direct/range {v1 .. v6}, Landroid/support/design/widget/j;-><init>(Landroid/content/Context;Landroid/graphics/drawable/Drawable;FFF)V

    iput-object p1, p0, Landroid/support/design/widget/f;->c:Landroid/support/design/widget/j;

    .line 145
    iget-object p1, p0, Landroid/support/design/widget/f;->c:Landroid/support/design/widget/j;

    invoke-virtual {p1, v0}, Landroid/support/design/widget/j;->a(Z)V

    .line 146
    iget-object p1, p0, Landroid/support/design/widget/f;->o:Landroid/support/design/widget/k;

    iget-object p2, p0, Landroid/support/design/widget/f;->c:Landroid/support/design/widget/j;

    invoke-interface {p1, p2}, Landroid/support/design/widget/k;->a(Landroid/graphics/drawable/Drawable;)V
